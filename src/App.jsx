...
function UjianTahap1() {
  const daftarMenu = [
    { id: 1, namaMenu: "Kopi Kenangan Mantan", harga: "Rp 20.000", deskripsi: "Manisnya pas, seperti janji manisnya." },
    { id: 2, namaMenu: "Kopi Susu Gula Aren", harga: "Rp 18.000", deskripsi: "Klasik, menenangkan, bikin melek." },
    { id: 3, namaMenu: "Americano Dingin", harga: "Rp 15.000", deskripsi: "Pahit, sekuat kenyataan hidup." },
    { id: 4, namaMenu: "Matcha Latte", harga: "Rp 25.000", deskripsi: "Hijau, lembut, dan bikin tenang." }
  ];
  return(
    <div style={{ border: '2px solid green', padding: '10px', marginTop: '20px' }}>
      <h2>Daftar Menu</h2>
